...
export default function cardProduto() {
  produtos.map((produto) => {
    ...
    pDescricao.classList = "text-gray-500 font-extralight";
    pDescricao.textContent = `${produto.descricao}`;
    const pTempo = document.createElement("p");
    pTempo.classList = "text-gray-500 font-extralight mt-2";
    ...
    btnAdd.classList =
      "btn-add bg-yellow-400 w-full uppercase pt-2 pb-1 text-xs text-white rounded-sm outline-none";
